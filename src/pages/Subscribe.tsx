    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-900 via-emerald-900 to-black">
      <div className="pt-6 pb-12 px-4">
        <div className="max-w-4xl mx-auto">
          {/* Back Button (VERY visible) */}
          <button
            type="button"
            onClick={() => window.history.back()}
            className="inline-flex items-center gap-2 mb-6 rounded-lg border border-emerald-500/50 bg-black/40 px-4 py-2 text-sm font-semibold text-emerald-300 hover:bg-black/60 transition"
          >
            ← Back
          </button>
          ...
          <div className="text-center">
            ...
            <div className="mb-12">
              <h1 className="text-4xl md:text-6xl font-bold text-white mb-6">
                Choose Your{" "}
                <span className="text-emerald-400">Underground</span> Access
              </h1>

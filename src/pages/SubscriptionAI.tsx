    ...
    <main className="min-h-screen bg-black text-white">
      <section className="max-w-3xl mx-auto px-4 py-10">
        ...
        <p className="text-sm text-gray-300 mb-4">
          Educational fitness and supplement guidance only. Not medical advice.
          Always talk to a licensed healthcare provider before starting or
          changing supplements, medications, or training.
        </p>

        {/* Memberstack gated content: only AIBMSA members should see the chat */}
        ...
        {/* Simple helper text + Memberstack modals */}
